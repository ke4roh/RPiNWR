...
class TestCAP(unittest.TestCase):
    ...
    def testTOW(self):
        ...
        self.assertFalse(cm.is_effective(when=lambda: 1463877539.9))
        self.assertTrue(cm.is_effective(when=lambda: 1463877540.0))
        self.assertTrue(cm.is_effective(when=lambda: 1463877541.0))
        self.assertTrue(cm.is_effective(when=lambda: 1463879700.0))
        self.assertFalse(cm.is_effective(when=lambda: 1463879700.1))
